    ...
    return (
        <section className="hero" id="home">
            <div className="hero-content">
                <h1>GEOLIZE</h1>
                <p>
                    Gestão inteligente de estacionamentos com câmeras, visão
                    computacional e IA: mapeamento de vagas em tempo real e
                    segurança ativa contra colisões, furtos e roubos.
                </p>
            </div>
        </section>
    );
